...
*/
functionBullet(ctx,startPosition,endPosition,mapArray,gunOffset,actorType){
...
varvectorX=this.startPosition.x-this.endPosition.x+this.gunOffset.x;
varvectorY=this.startPosition.y-this.endPosition.y+this.gunOffset.y;
vardistance=this.calculateDistance(_this.startPosition.x+_this.gunOffset.x,_this.startPosition.y+_this.gunOffset.y,_this.endPosition.x,_this.endPosition.y);
...
vartoPositionX=_this.fromPosition.x+_this.vector.x*_this.speed;
vartoPositionY=_this.fromPosition.y+_this.vector.y*_this.speed;
