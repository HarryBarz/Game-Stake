/**
*Createdbyasimon4/10/17.
*/
functionRobotUnit(id,ctx,startPosition,shyame,robotUnits,mapArray,collisionHandler,game,resources){
...
this.weapon=newWeapon(this.ctx,this.collisionHandler,'robot-unit',this.resources);

varbulletsFireInterval=Util.getRandomInt(2,5);
...
varpositionToFireX=_this.shyame.actor.position.x+_this.shyame.actor.actorWidth/2;
varpositionToFireY=_this.shyame.actor.position.y+_this.shyame.actor.actorHeight/2;

vardistanceToShyame=Util.calculateDistance(positionToFireX,positionToFireY,_this.position.x,_this.position.y);
...
vary=Math.round((_this.position.y+_this.actorHeight)/TILE_SIZE)-1;
varx=Math.round((_this.position.x+_this.actorHeight)/TILE_SIZE)-1;
...
varvectorX=_this.shyame.actor.position.x-weaponBackPositionX;
varvectorY=_this.shyame.actor.position.y-weaponBackPositionY;

vardistance=Util.calculateDistance(weaponBackPositionX,weaponBackPositionY,_this.shyame.actor.position.x,_this.shyame.actor.position.y);
